...
-- 회원 정보 테이블 생성
CREATE TABLE member(
seq NUMBER NOT NULL,         -- 회원수 - 시퀀스 적용
id VARCHAR2(30) PRIMARY KEY, -- 회원 ID - (중복 X, 유일키)
name VARCHAR2(30) NOT NULL,  -- 회원이름 - null 값 사용불가
age NUMBER(3),               -- 회원나이
height NUMBER(10, 2),        -- 회원키 - 전체 10자리, 소수점 2번째 자리까지
logtime DATE                 -- 생성일자
);
...
-- 데이터 추가
INSERT INTO member VALUES(member_seq.NEXTVAL, 'u001', 'userA', 100, 123.45, sysdate);
